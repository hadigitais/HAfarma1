  ...
  head: () => ({
    meta: [
      ...
      { title: "Farmácia CRM — Gestão comercial para farmácias" },
      {
        name: "description",
        content:
          "CRM comercial para farmácias: clientes, produtos, vendas, estoque e indicadores em um painel único.",
      },
      { property: "og:title", content: "Farmácia CRM — Gestão comercial para farmácias" },
      {
        property: "og:description",
        content: "Clientes, produtos, vendas, estoque e indicadores comerciais para farmácias.",
      },
